...
var updateCollection = function (db, dataObj, options) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        var _a, _b, _i, index, collectionName, _c, _d, _e, doc, docId, subCollections, subCollections, _f, _g, _h, subIndex, revivedSubCollection, subCollectionPath;
        return __generator(this, function (_j) {
            switch (_j.label) {
                ...
                case 2:
                    ...
                    doc = _c[_e];
                    if (!dataObj[index].hasOwnProperty(doc)) return [3 /*break*/, 11];
                    docId = Array.isArray(dataObj[index]) ? uuid_1.v1() : doc;
                    if (!!Array.isArray(dataObj[index])) return [3 /*break*/, 6];
                    subCollections = dataObj[index][docId]['subCollection'];
                    delete dataObj[index][doc]['subCollection'];
                    return [4 /*yield*/, startUpdating(db, collectionName, docId, dataObj[index][doc], options)];
                case 3:
                    _j.sent();
                    if (!subCollections) return [3 /*break*/, 5];
                    return [4 /*yield*/, updateCollection(db, subCollections, options)];
                case 4:
                    _j.sent();
                    _j.label = 5;
                case 5: return [3 /*break*/, 11];
                case 6:
                    subCollections = dataObj[index][doc]['subCollection'];
                    delete dataObj[index][doc]['subCollection'];
                    return [4 /*yield*/, startUpdating(db, collectionName, docId, dataObj[index][doc], options)];
                case 7:
                    _j.sent();
                    if (!subCollections) return [3 /*break*/, 11];
                    _f = [];
                    for (_g in subCollections)
                        _f.push(_g);
                    _h = 0;
                    _j.label = 8;
                case 8:
                    ...
                    subCollectionPath = collectionName + "/" + docId + "/" + subIndex;
...
var startUpdating = function (db, collectionName, docId, data, options) {
    ...
    if (options.geos && options.geos.length > 0) {
        var makeGeoPoint_1 = function (geoValues) {
        ...
        options.geos.forEach(function (geo) {
            if (data.hasOwnProperty(geo)) {
                ...
                if (Array.isArray(data[geo])) {
                    data[geo] = data[geo].map(function (geoValues) { return makeGeoPoint_1(geoValues); });
                }
                else {
                    data[geo] = makeGeoPoint_1(data[geo]);
                }
            }
            if (geo.indexOf('.') > -1) {
                helper_1.traverseObjects(data, function (value) {
